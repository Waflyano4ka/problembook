<template>
  <v-container class="px-12 pt-0">
    <v-card flat class="rounded-t-xl mt-9" style="padding-top: 1px">
      <v-toolbar :color="OBJECT.color" extended flat class="pt-0 repeating-gradient" height="64px" style="border-top-left-radius: 32px;">
      ...
      <v-tabs vertical color="accent" v-model="model">
        ...
        <v-tabs-items v-model="model">
          ...
          <v-tab-item :value="`members`">
            <v-card flat class="rounded-0">
              <members-list :archiveBool="archiveBool"/>
            </v-card>
          </v-tab-item>
        </v-tabs-items>
      </v-tabs>
